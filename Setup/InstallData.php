            ...
            'content' =>
                '<p>Welcome to 
                    <a title="Magento 2 Blog extension" 
                       ...
                       target="_blank">Magento 2 Blog extension
                    </a> by
                    <a title="Magento 2 Extensions" 
                       href="https://magefan.com/magento2-extensions"
                       target="_blank">Magefan
                    </a>. This is your first post. Edit or delete it, then start blogging!
                </p>
                <p><!-- pagebreak --></p>
                <p>Please also read&nbsp;
                    ...
                    <a href="https://magefan.com/blog/add-read-more-tag-to-blog-post-content" 
                       target="_blank">How to add "read more" tag to post content
                    </a>
                </p>
                <p>Follow Magefan on:</p>
                <p>
                    <a title="Blog Extension for Magento 2 code" 

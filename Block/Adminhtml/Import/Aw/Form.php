    ...
    protected function _prepareForm()
    {
        ...
        $fieldset->addField(
            ...
            [
                'label' => __('NOTICE'),
                'name' => 'prefix',
                'after_element_html' => 'When the import is completed successfully, please copy image files from Aw <strong style="color:#bd1616;">aw-content/uploads</strong> directory to Magento <strong style="color:#105610;">pub/media/magefan_blog</strong> directory.',
            ]
        );
        ...
        $this->_eventManager->dispatch('magefan_blog_import_aw_prepare_form', ['form' => $form]);

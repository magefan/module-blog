...
namespace Magefan\Blog\Block\Adminhtml\Import\Mageplaza;
    ...
    protected function _prepareForm()
    {
        ...
        $fieldset->addField(
            ...
            [
                ...
                'required' => true,
                'disabled' => $isElementDisabled,
                'after_element_html' => '<small>The name of the database you run in Mageplaza.</small>',
            ]
        );
        ...
        $fieldset->addField(
            ...
            [
                ...
                'required' => true,
                'disabled' => $isElementDisabled,
                'after_element_html' => '<small>Your Mageplaza MySQL username.</small>',
            ]
        );
        ...
        $fieldset->addField(
            ...
            [
                ...
                'required' => false,
                'disabled' => $isElementDisabled,
                'after_element_html' => '<small>…and your Mageplaza MySQL password.</small>',
            ]
        );
        ...
        $fieldset->addField(
            ...
            [
                ...
                'required' => true,
                'disabled' => $isElementDisabled,
                'after_element_html' => '<small>…and your Mageplaza MySQL host.</small>',
            ]
        );
        ...
        $fieldset->addField(
            ...
            [
                ...
                'required' => false,
                'disabled' => $isElementDisabled,
                'after_element_html' => '<small>…and your Mageplaza MySQL table prefix.</small>',
            ]
        );

        $this->_eventManager->dispatch('magefan_blog_import_mageplaza_prepare_form', ['form' => $form]);
